...
Azure App Service にデプロイする場合は、「[チュートリアル:Azure App Service への SSL 証明書のアップロードとバインド](/azure/app-service/app-service-web-tutorial-custom-ssl)」のガイダンスに従ってください。
