# <a name="visual-studiotabvisual-studio"></a>[<span data-ttu-id="f30b0-101">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="f30b0-101">Visual Studio</span></span>](#tab/visual-studio)
