<span data-ttu-id="2e7a5-101">次の .NET Core CLI コマンドを実行します。</span><span class="sxs-lookup"><span data-stu-id="2e7a5-101">Run the following .NET Core CLI commands:</span></span>
