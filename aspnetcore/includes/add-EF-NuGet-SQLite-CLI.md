<span data-ttu-id="5c876-101">次の .NET Core CLI コマンドを実行します。</span><span class="sxs-lookup"><span data-stu-id="5c876-101">Run the following .NET Core CLI commands:</span></span>
