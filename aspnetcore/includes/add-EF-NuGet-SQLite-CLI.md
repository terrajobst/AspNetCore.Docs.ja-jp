<span data-ttu-id="b005c-101">次の .NET Core CLI コマンドを実行します。</span><span class="sxs-lookup"><span data-stu-id="b005c-101">Run the following .NET Core CLI commands:</span></span>
