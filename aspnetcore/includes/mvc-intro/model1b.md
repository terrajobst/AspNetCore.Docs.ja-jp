<span data-ttu-id="73ed1-101">`Movie` クラスに次のプロパティを追加します。</span><span class="sxs-lookup"><span data-stu-id="73ed1-101">Add the following properties to the `Movie` class:</span></span>
