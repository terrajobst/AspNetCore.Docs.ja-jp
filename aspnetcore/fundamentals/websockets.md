...
1. <span data-ttu-id="6a1c5-203">追加機能が不要な場合は、 **[次へ]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="6a1c5-203">If additional features aren't needed, select **Next**.</span></span>
