# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="b0deb-101">ASP.NET Core の URL リライト サンプル</span><span class="sxs-lookup"><span data-stu-id="b0deb-101">ASP.NET Core URL Rewriting Sample</span></span>
