# <a name="upload-files-sample-app"></a><span data-ttu-id="a4eff-101">ファイルのアップロードのサンプル アプリ</span><span class="sxs-lookup"><span data-stu-id="a4eff-101">Upload Files Sample App</span></span>
