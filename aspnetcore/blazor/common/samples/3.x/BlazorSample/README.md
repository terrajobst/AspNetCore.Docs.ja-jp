# <a name="blazor-client-side-sample-app"></a><span data-ttu-id="baacd-101">Blazor (クライアント側) のサンプルアプリ</span><span class="sxs-lookup"><span data-stu-id="baacd-101">Blazor (client-side) Sample App</span></span>
