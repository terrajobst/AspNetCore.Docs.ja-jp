...
---
# <a name="use-aspnet-core-opno-locsignalr-with-typescript-and-webpack"></a><span data-ttu-id="e0d50-103">TypeScript と Webpack で ASP.NET Core [!OP.NO-LOC(SignalR)] を使用する</span><span class="sxs-lookup"><span data-stu-id="e0d50-103">Use ASP.NET Core [!OP.NO-LOC(SignalR)] with TypeScript and Webpack</span></span>
...
<span data-ttu-id="e0d50-105">[Webpack](https://webpack.js.org/) を使用すると、開発者は Web アプリのクライアント側のリソースをバンドルおよびビルドすることができます。</span><span class="sxs-lookup"><span data-stu-id="e0d50-105">[Webpack](https://webpack.js.org/) enables developers to bundle and build the client-side resources of a web app.</span></span> <span data-ttu-id="e0d50-106">このチュートリアルでは、クライアントが [TypeScript](https://www.typescriptlang.org/) で記述された ASP.NET Core [!OP.NO-LOC(SignalR)] Web アプリでの Webpack の使用法を示します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-106">This tutorial demonstrates using Webpack in an ASP.NET Core [!OP.NO-LOC(SignalR)] web app whose client is written in [TypeScript](https://www.typescriptlang.org/).</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="e0d50-108">スターター ASP.NET Core [!OP.NO-LOC(SignalR)] アプリをスキャフォールディングする</span><span class="sxs-lookup"><span data-stu-id="e0d50-108">Scaffold a starter ASP.NET Core [!OP.NO-LOC(SignalR)] app</span></span>
> * <span data-ttu-id="e0d50-109">[!OP.NO-LOC(SignalR)] TypeScript クライアントを構成する</span><span class="sxs-lookup"><span data-stu-id="e0d50-109">Configure the [!OP.NO-LOC(SignalR)] TypeScript client</span></span>
...
> * <span data-ttu-id="e0d50-111">[!OP.NO-LOC(SignalR)] サーバーを構成する</span><span class="sxs-lookup"><span data-stu-id="e0d50-111">Configure the [!OP.NO-LOC(SignalR)] server</span></span>
...
1. <span data-ttu-id="e0d50-165">プロジェクト ルートに、次の内容を持つ *webpack.config.js* という名前のファイルを作成します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-165">Create a file named *webpack.config.js*, in the project root, with the following content:</span></span>
    ...
    * <span data-ttu-id="e0d50-170">`resolve.extensions` 配列には、[!OP.NO-LOC(SignalR)] クライアント JavaScript をインポートするための *.js* が含まれています。</span><span class="sxs-lookup"><span data-stu-id="e0d50-170">The `resolve.extensions` array includes *.js* to import the [!OP.NO-LOC(SignalR)] client JavaScript.</span></span>
...
1. <span data-ttu-id="e0d50-203">プロジェクト ルートで、次のコマンドを実行します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-203">Execute the following command at the project root:</span></span>
    ...
    <span data-ttu-id="e0d50-204">上記のコマンドにより [[!OP.NO-LOC(SignalR)] TypeScript クライアント](https://www.npmjs.com/package/@microsoft/signalr) がインストールされ、クライアントがサーバーにメッセージを送信できるようになります。</span><span class="sxs-lookup"><span data-stu-id="e0d50-204">The preceding command installs the [[!OP.NO-LOC(SignalR)] TypeScript client](https://www.npmjs.com/package/@microsoft/signalr), which allows the client to send messages to the server.</span></span>
...
1. <span data-ttu-id="e0d50-309">プロジェクト ルートに、次の内容を持つ *webpack.config.js* という名前のファイルを作成します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-309">Create a file named *webpack.config.js*, in the project root, with the following content:</span></span>
    ...
    * <span data-ttu-id="e0d50-314">`resolve.extensions` 配列には、[!OP.NO-LOC(SignalR)] クライアント JavaScript をインポートするための *.js* が含まれています。</span><span class="sxs-lookup"><span data-stu-id="e0d50-314">The `resolve.extensions` array includes *.js* to import the [!OP.NO-LOC(SignalR)] client JavaScript.</span></span>
...
1. <span data-ttu-id="e0d50-339">プロジェクト ルートに *Hubs* という新しいディレクトリを作成します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-339">Create a new directory, called *Hubs*, in the project root.</span></span> <span data-ttu-id="e0d50-340">その目的は、次の手順で作成される [!OP.NO-LOC(SignalR)] ハブを格納することです。</span><span class="sxs-lookup"><span data-stu-id="e0d50-340">Its purpose is to store the [!OP.NO-LOC(SignalR)] hub, which is created in the next step.</span></span>
...
1. <span data-ttu-id="e0d50-347">プロジェクト ルートで、次のコマンドを実行します。</span><span class="sxs-lookup"><span data-stu-id="e0d50-347">Execute the following command at the project root:</span></span>
    ...
    <span data-ttu-id="e0d50-348">上記のコマンドにより [[!OP.NO-LOC(SignalR)] TypeScript クライアント](https://www.npmjs.com/package/@microsoft/signalr) がインストールされ、クライアントがサーバーにメッセージを送信できるようになります。</span><span class="sxs-lookup"><span data-stu-id="e0d50-348">The preceding command installs the [[!OP.NO-LOC(SignalR)] TypeScript client](https://www.npmjs.com/package/@microsoft/signalr), which allows the client to send messages to the server.</span></span>
